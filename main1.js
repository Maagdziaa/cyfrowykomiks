const comicFrames = [
    ...
    { type: "single", src: "images/19.png", hasTask: true, taskId: "task-1", subtasks: [
        { id: "subtask-1-1", type: "text", description: " a) " , correctAnswer: "3x3" },
        { id: "subtask-1-2", type: "text", description: "b) " ,correctAnswer: "1x3" },
        { id: "subtask-1-3", type: "text", description: "c) " , correctAnswer: "3x1" },
        { id: "subtask-1-4", type: "text", description: "d) " , correctAnswer: "2x3" },
		{ id: "subtask-1-5", type: "text", description: "e) " , correctAnswer: "2x2" }
    ] },
    { type: "single", src: "images/20.png", hasTask: true, taskId: "task-2", subtasks: [
        { id: "subtask-2-1", type: "text", description: " a) Macierz, złożona z samych zer to ..." , correctAnswer: "macierz zerowa" },
        { id: "subtask-2-2", type: "text", description: "b) Macierz, która ma taką samą liczbę wierszy i kolumn to ..." ,correctAnswer: "macierz kwadratowa" },
        { id: "subtask-2-3", type: "text", description: "c) Macierz kwadratowa, która poza główną przekątną ma same zera i dodatkowo cyframi na głównej przekątnej są same jedynki, to ..." , correctAnswer: "macierz jednostkowa" },
        { id: "subtask-2-4", type: "text", description: "d) Macierz ... to taka macierz kwadratowa, która poniżej głównej przekątnej ma same zera." , correctAnswer: "trójkątna górna" }
    ]  },
    ...
    { type: "single", src: "images/24.png", hasTask: true, taskId: "task-6", subtasks: [
        { id: "subtask-6-1", type: "text", description: " a) " , correctAnswer: "10" },
        { id: "subtask-6-2", type: "text", description: "b) " ,correctAnswer: "-50" },
        { id: "subtask-6-3", type: "text", description: "c) " , correctAnswer: "0" },
        { id: "subtask-6-4", type: "text", description: "d) " , correctAnswer: "1" }
    ]  },
    ...
    { type: "single", src: "images/26.png", hasTask: true, taskId: "task-8" , subtasks: [
        { id: "subtask-8-1", type: "text", description: " a) " , correctAnswer: "układ nieoznaczony" },
        { id: "subtask-8-2", type: "text", description: "b) " ,correctAnswer: "układ oznaczony, x=2,y=3,z=-1" },
        { id: "subtask-8-3", type: "text", description: "c) " , correctAnswer: "układ sprzeczny" },
        { id: "subtask-8-4", type: "text", description: "d) " , correctAnswer: "układ oznaczony, x=4,y=-2,z=0,t=1" }
    ]  },
